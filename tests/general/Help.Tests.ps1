...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ExchangeOnlineArchiveTransfer\functions", "$global:testroot\..\ExchangeOnlineArchiveTransfer\internal\functions"),
	
	[string]
	$ModuleName = "ExchangeOnlineArchiveTransfer",
...
$CommandPath = @(
    "$global:testroot\..\ExchangeOnlineArchiveTransfer\functions"
    "$global:testroot\..\ExchangeOnlineArchiveTransfer\internal\functions"
)
