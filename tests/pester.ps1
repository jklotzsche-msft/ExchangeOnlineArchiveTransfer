...
Remove-Module ExchangeOnlineArchiveTransfer -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ExchangeOnlineArchiveTransfer\ExchangeOnlineArchiveTransfer.psd1"
Import-Module "$PSScriptRoot\..\ExchangeOnlineArchiveTransfer\ExchangeOnlineArchiveTransfer.psm1" -Force
