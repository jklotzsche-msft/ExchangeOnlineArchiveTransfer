...
GUID = '4d139d29-6720-430c-afd7-bc1e2bf54308'
...
RequiredAssemblies = @(
    'bin\Microsoft.Exchange.WebServices.Auth.dll'
...
FunctionsToExport = @(
    'Connect-EOATExchangeWebService',
    'Disconnect-EOATExchangeWebService',
    'Get-EOATMailFolder',
    'Get-EOATMailItem',
    'Move-EOATMailItemToOtherMailbox',
    'Copy-EOATMailItemToOtherMailbox'
)
